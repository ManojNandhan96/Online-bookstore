...
export class BookService {
  ...
  searchbykeywordurl = `${this.baseUrl}/books/search`;
  ...
  searchByKeyword(keyword: string): Observable<Book[]> {
    return this.httpClient.get<GetResponseBooks>(this.searchbykeywordurl+'/searchbykeyword?name='+keyword).pipe(
          map(response => response._embedded.books)
      );
  }
